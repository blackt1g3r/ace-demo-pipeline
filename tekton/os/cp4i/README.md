...
For example, the following sequence would tage the 12.0.4.0-r1 image and upload to the registry:
```
docker pull cp.icr.io/cp/appc/ace-server-prod@sha256:c41154c17a30bbbb6e1e4593c965f49ef3c86260e71143b8f33a6fbca277a3b9
docker tag cp.icr.io/cp/appc/ace-server-prod@sha256:c41154c17a30bbbb6e1e4593c965f49ef3c86260e71143b8f33a6fbca277a3b9 image-registry.openshift-image-registry.svc.cluster.local:5000/default/ace-server-prod:12.0.4.0-r1
docker push image-registry.openshift-image-registry.svc.cluster.local:5000/default/ace-server-prod:12.0.4.0-r1
```
...
```
cp.icr.io/cp/appc/ace-server-prod:12.0.4.0-r1-20230421-154140
